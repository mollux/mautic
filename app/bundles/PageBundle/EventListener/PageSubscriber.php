...
{
    public function __construct(private AssetsHelper $assetsHelper, private IpLookupHelper $ipLookupHelper, private AuditLogModel $auditLogModel, private PageModel $pageModel, private Logger $logger, private HitRepository $hitRepository, private PageRepository $pageRepository, private RedirectRepository $redirectRepository, private LeadRepository $contactRepository)
    {
    }
