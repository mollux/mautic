...
trait ExpressionHelperTrait
{
     ...
     * @return mixed
     */
    public function generateFilterExpression(\Doctrine\DBAL\Query\QueryBuilder|\Doctrine\ORM\QueryBuilder $q, $column, $operator, $parameter, $includeIsNull, CompositeExpression $appendTo = null)
    {
