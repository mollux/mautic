...
class CacheHelper
{
    public function __construct(private string $cacheDir, private ?\Symfony\Component\HttpFoundation\Session\Session $session, private PathsHelper $pathsHelper, private KernelInterface $kernel)
    {
    }
