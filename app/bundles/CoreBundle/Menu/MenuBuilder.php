...
class MenuBuilder
{
     ...
     */
    public function __construct(private FactoryInterface $factory, private MatcherInterface $matcher, private EventDispatcherInterface $dispatcher, private MenuHelper $menuHelper)
    {
    }
