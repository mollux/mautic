...
{
    public function __construct(private UserHelper $userHelper, private ReportModel $reportModel, private CorePermissions $security, private TemplatingHelper $templating)
    {
    }
