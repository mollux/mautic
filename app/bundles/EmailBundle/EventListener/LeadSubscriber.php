...
{
    public function __construct(private EmailReplyRepositoryInterface $emailReplyRepository, private StatRepository $statRepository, private TranslatorInterface $translator, private RouterInterface $router)
    {
    }
